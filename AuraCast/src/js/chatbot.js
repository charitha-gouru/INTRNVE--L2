...
function sendInstructionalMessage() {
  const instructionMessage =
    "Hello! I am your AuraCast Assistant 🌤. I can provide weather information for you. To get started, type 'weather in [a city's name]' to get the weather for that city. Or you can also ask me any general weather-related questions or any other queries you may have. How can I assist you today? 🌤";
...
chatTitleElem.innerText = 'Chat With Your AuraCast!';
...
chatInput.addEventListener('keydown', e => {
  if (e.key === 'Enter' && e.target.value.trim()) {
    ...
    setTimeout(async () => {
      ...
      elizaMsgElem.innerText = `AuraCast: ${response}`;
